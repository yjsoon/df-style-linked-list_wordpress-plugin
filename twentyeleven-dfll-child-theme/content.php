	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<footer class="entry-meta">
            ...
            <?php if (is_linked_list()): ?>
              <div class="linked-list-permalink"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_permalink_glyph(); ?></a></div>
            <?php endif; ?>
